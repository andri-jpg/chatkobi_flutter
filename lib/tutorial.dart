import 'package:chatkobi/termux.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Langkah 2: Install ChatKobi Offline',
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 10),
...
wget https://raw.githubusercontent.com/andri-jpg/termux-fa/main/prompter.py
echo 'python prompter.py' > script.sh
chmod +x script.sh
...
''',
        style: TextStyle(fontFamily: 'monospace'),
            ...
            const SizedBox(height: 20),
            const Text(
              'Selamat Instalasi selesai. untuk menggunakan chatkobi',
              style: TextStyle(fontSize: 16),
            ),
            InkWell(
              onTap: () {
